...
module.exports = {
  ...
  coveragePathIgnorePatterns: [
    ...
    'packages/dpos/manage/registerDelegateMultiStep/index.js',
    'packages/dpos/manage/registerDelegateMultiStep/element.js',
    'packages/dpos/manage/registerDelegateMultiStep/utils.js',
    'packages/dpos/manage/registerDelegateMultiStep/navigator.js',
    'packages/dpos/manage/registerDelegateMultiStep/navigatorButton.js',
    ...
    'packages/updater/detail/info/newReleaseDialog/index.js',
    'packages/transaction/detail/info/transactionInfo/',
    'packages/views/shared/formattedNumber/stories.js',
    'packages/views/shared/header/signInHeader/signInHeader.js',
    'packages/transaction/detail/info/transactionTypeFigure/index.js',
    'packages/views/shared/filterDropdownButton/textFilter.js',
    'packages/transaction/detail/info/transactionAmount/index.js',
    'packages/views/shared/searchBar/transactions.js',
    'packages/views/shared/navigationBars/topBar/networkName.js',
    'packages/views/wallet/detail/info/multisignatureMembers/index.js',
    'packages/dpos/detail/info/warnPunishedDelegate/warnPunishedDelegate.js',
    'packages/dpos/detail/info/warnPunishedDelegate/index.js',
    'packages/dpos/detail/info/warnPunishedDelegate/voteWarning.js',
    ...
    'packages/wallet/detail/info/walletDetails/walletDetails.js',
    'packages/common/utilities/login.js',
    'packages/transaction/detail/manager/transactionResult/index.js',
    ...
    'packages/transaction/detail/info/transactionSummary/index.js',
    'packages/views/screens/router/routes.js',
    'packages/common/store/selectors.js',
    'packages/dpos/store/reducers/voting.js',
    'src/utils/voting.js',
    'packages/transaction/detail/manager/transactionResult/illustrations.js',
    'packages/transaction/detail/manager/transactionResult/regular.js',
  ],
  coverageThreshold: {
    global: {
      branches: 90,
