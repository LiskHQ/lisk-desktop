...
module.exports = {
  ...
  collectCoverageFrom: ['packages/**/*.js', 'setup/**/*.js', 'scripts/app/src/**/*.js'],
  coveragePathIgnorePatterns: [
    '/node_modules/',
    '.test.js',
    '.stories.js',
    'scripts/app/src/ipc.js',
    'scripts/app/src/ledger.js',
    'scripts/app/src/utils.js',
    'scripts/app/src/hwManager.js',
    'scripts/app/src/trezor.js',
    'scripts/app/src/modules/win.js',
    'scripts/app/src/modules/localeHandler.js',
    'scripts/app/src/modules/storage.js',
    'src/utils/testHelpers.js',
    'src/constants/',
    'scripts/i18n/i18n-scanner.js',
    'setup/react/main.js',
    'tests/tests.js',
    'scripts/app/src/modules/autoUpdater.js',
    'src/store/index.js',
    ...
    'packages/views/shared/warnPunishedDelegate/warnPunishedDelegate.js',
    'packages/views/shared/warnPunishedDelegate/index.js',
    'packages/views/shared/warnPunishedDelegate/voteWarning.js',
    ...
    'packages/common/utilities/api/transaction/btc.js',
    ...
    'packages/common/utilities/api/account/btc.js',
    ...
    'packages/common/utilities/api/block/index.js',
    'packages/common/utilities/api/transaction/lsk.js',
