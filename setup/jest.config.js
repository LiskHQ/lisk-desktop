...
module.exports = {
  ...
  coveragePathIgnorePatterns: [
    ...
    'src/modules/dpos/validator/components/ToggleIcon/index.js',
    'src/modules/dpos/validator/components/delegateProfile/voterRow.js',
    'src/modules/auth/components/hwWalletLogin/hwWalletLogin.js',
    'src/modules/dpos/validator/components/delegateProfile/performanceView.js',
    'src/modules/dpos/validator/components/delegateProfile/detailsView.js',
    'src/modules/dpos/validator/components/delegateProfile/delegateProfile.js',
    'src/modules/common/components/newsFeed/news.js',
    'src/modules/common/components/newsFeed/newsFeed.js',
    'src/modules/dpos/validator/components/delegatePerformance/delegatePerformanceDetails.js',
    ...
    'src/modules/account/utils/encryptAccount.js',
    'src/modules/account/hooks/useEncryptAccount.js',
    'src/modules/account/hooks/useCurrentAccount.js',
    'src/modules/auth/components/SetPasswordForm/SetPasswordForm.js',
    'src/modules/wallet/components/signMultisigView/progressBar.js',
    'src/modules/transaction/components/RegisterMultisignatureGroup/RegisterMultisignatureGroup',
    'src/modules/wallet/components/RegisterMultisigSummary/Summary.js',
    'src/modules/wallet/components/signMultisigSummary/summary.js',
    'src/modules/account/components/AddAccountBySecretRecovery/AddAccountBySecretRecovery.js',
    'src/modules/account/components/BackupRecoveryPhraseFlow/BackupRecoveryPhraseFlow.js',
    'src/modules/account/components/RemoveConfirmation/RemoveConfirmation.js',
    'src/modules/transaction/store/actions.js',
  ],
  coverageThreshold: {
    // global: {
