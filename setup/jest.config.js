...
module.exports = {
  ...
  testPathIgnorePatterns: [
    ...
    'packages/views/screens/managers/dashboard/newsFeed/index.js', // This component doesn't meet the setted tresholds for mocha but in jest
  ...
  coveragePathIgnorePatterns: [
    ...
    'src/modules/transaction/api/btc.js',
    'src/modules/network/utils/api/lsk.js',
    'src/modules/network/utils/api/btc.js',
    ...
    'src/modules/search/api/lsk.js',
    'src/modules/search/api/btc.js',
    'src/modules/wallet/utils/api/btc.js',
    ...
    'src/modules/transaction/api/lsk.js',
    ...
    'src/modules/wallet/utils/api/lsk.js',
    ...
    'app/src/main.js',
    'src/modules/account/hooks/decryptionAccount.js',
  ],
  coverageThreshold: {
    // global: {
    //   branches: 90,
