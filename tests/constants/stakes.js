...
const generateStakes = (index) => ({
  params: { stakes: [{ validatorAddress: `lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y${index + 10}`, amount: `${index + 10}0000000` }] },
  block: {
...
export const stakesList = Array(10).fill(1).map((_, idx) => generateStakes(idx));
