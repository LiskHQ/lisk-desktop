...
Then(/^request token page should be properly displayed$/, function () {
  cy.contains('Use the sharing link to easily request any amount of tokens from Lisk Desktop or Lisk Mobile users.')
  .eq(0)
  .should('have.text', 'Use the sharing link to easily request any amount of tokens from Lisk Desktop or Lisk Mobile users.');
