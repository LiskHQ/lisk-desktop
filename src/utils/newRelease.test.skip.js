...
//   it.skip('Should return undefined if no ipc on window', () => {
//     delete window.ipc;
//     expect(newReleaseUtil.init()).toEqual(undefined);
//   });

//   it.skip('Should fire success toaster when ipc receives update:downloading', () => {
...
//   it.skip('Should call FlashMessageHolder.addMessage when ipc receives update:available', () => {
...
//   it.skip('Should initiate the update process if clicked on updateNow', () => {
