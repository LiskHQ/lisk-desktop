...
const TransactionsHeaderV2 = ({ t }) => (
  <div className={`${grid.row} ${styles.row} ${styles.header}`} id="transactionsHeader">
    ...
    <div className={`${styles.hiddenXs} ${grid['col-sm-2']} ${grid['col-lg-3']} transactions-header`}>{t('Details')}</div>
    <div className={`${styles.hiddenXs} ${grid['col-sm-2']} ${grid['col-lg-2']} transactions-header`}>{t('Date')}</div>
    <div className={`${styles.hiddenXs} ${grid['col-sm-2']} ${grid['col-lg-2']} transactions-header`}>{t('Transaction Fee')}</div>
