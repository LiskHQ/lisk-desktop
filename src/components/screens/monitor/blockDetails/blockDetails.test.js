...
describe('BlockDetails page', () => {
  ...
  it('renders a page properly without errors', () => {
    ...
    expect(wrapper.find('label').at(6)).toHaveText('Total burnt');
    expect(wrapper.find('label').at(7)).toHaveText('Total forged');
    expect(wrapper.find('label').at(8)).toHaveText('Total amount');
    expect(wrapper.find('label').at(9)).toHaveText('Date');
    expect(wrapper.find('label').at(10)).toHaveText('Generated by');
