...
describe('Delegates', () => {
  ...
  it.skip('should not show "Register delegate" button if already delegate', () => {
    wrapper = mount(
      <Delegates {...{
        ...props,
