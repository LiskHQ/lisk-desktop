...
describe('Dialog.Options component', () => {
  it.skip('Should render with single option, clicking option calls DialogHolder.hideDialog', () => {
    const wrapper = mount(
      <Options>
  ...
  it.skip('Should render multiple options calls DialogHolder.hideDialog even if onClick is set', () => {
