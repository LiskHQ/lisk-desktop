...
function MenuSelect({
  ...
  return (
    <>
      ...
      <div data-testid="dropdown-input" onClick={handleOnClick} className={`${styles.wrapper} ${className}`}>
      ...
      {!showDropdown && !isLoading && <Feedback message={feedback} size={size} status={status} />}
    </>
  );
}
