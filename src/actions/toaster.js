 ...
 *
 */
export const successToastDisplayed = ({ type = 'success', ...rest }) => toastDisplayed({ type, ...rest });
 ...
 *
 */
export const errorToastDisplayed = ({ type = 'error', ...rest }) => toastDisplayed({ type, ...rest });
