...
import { PrimaryButton, SecondaryButton, TertiaryButton, WarningButton } from '.';
...
storiesOf('Toolbox', module).add('Button', () => (
  <StoryWrapper>
    <h3>Enabled State</h3>
    ...
    <DarkWrapper>
      <SecondaryButton className="light" onClick={action('clicked')}>
    ...
    <DarkWrapper>
      <SecondaryButton className="light" disabled onClick={action('clicked')}>
        Secondary Button - Light
      </SecondaryButton>
    </DarkWrapper>
    ...
    <PrimaryButton size="m" onClick={action('clicked')}>
      {' '}
      Size m{' '}
    </PrimaryButton>
    ...
    <PrimaryButton size="xs" onClick={action('clicked')}>
      {' '}
      Size xs{' '}
    </PrimaryButton>
  </StoryWrapper>
